...
$sek = file_get_contents("sek.txt");
$sekk = file_get_contents("sekk.txt");
if ($text == "تفعيل البوت الخدمي" or $text == "♔ تفعيل بوت الخدمي" and in_array($from_id,$Dev)){
...
file_put_contents("data/namebot.txt","همس");
...
"معاك حياتي امرني 🥺💞",
"وش تبغى كل شويه $namebot",
"خلاص بس كل شويه $namebot جننتنا"
);
...
$abuehab = array("هلا قلبي معاك همس","تفضل حبيبي انا همس🌝💞","معاك حياتي امرني 🥺💞","وش تبغى كل شويه همس","جننتنا خلاص كل شويه همس بس");
$ehab = array_rand($proxre, 1);
if($text == "همس" and $namebot == NULL){
if ($tc == 'group' | $tc == 'supergroup'){
