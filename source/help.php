...
bot('sendmessage',['chat_id'=>$chat_id,'text'=>" $starttext
",'parse_mode'=>'MarkDown', 'disable_web_page_preview'=>true,'reply_to_message_id'=>$message->message_id,
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"✵⁞  دعوة البوت ",'url'=>"https://telegram.me/$userbot?startgroup=start"]],
[['text'=>"✵⁞ المطور ⁞✵",'url'=>"t.me/$buy"]],
...
[['text'=>"♔𝘀𝗼𝘂𝗿𝗰𝗲 𝙝𝙢𝙨♔",'url'=>"https://t.me/botatiiii"]],
]])]);}
$ex = explode("#",$data);
