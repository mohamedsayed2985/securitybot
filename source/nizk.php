...
$token = "6163482687:AAFi6q2pFp5m4HeI9ARpWxjX2gY-sUIGHZM";// توكنك 
...
#############
$admin = "6074694489";
$Dev = array("$admin","6074694489","6033041149");
$eri = array("$admin","6074694489");
$idbot = "6163482687";
$sudo = "$admin";
$buy = "M_W_F1";
$DevUser = "@$buy";
...
$grouplisturl = $user["grouplist"];
if( $text == "الروابط" or $text == "♔ روابط المجموعات" or $text == "قائمة روابط المجموعات" or $text == "قائمه روابط المجموعات" or $text == "قائمة الروابط" and $settings["silentlist"]!== NULL){
