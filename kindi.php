...
ob_start();
##########
$token = "6242470101:AAH__s-dNgVc7RRnvo5HndK2zkjaN-VoUdk"; // توكنك
$kindi = "6242470101:AAH__s-dNgVc7RRnvo5HndK2zkjaN-VoUdk";// توكنك

$buy = "AIikindi";
$userbot ="alamIagbot";
$sudo = "6032111170"; // ايديك
$admin = "$sudo";
$idBot = "6242470101";// ايدي بوتك
$admmm = $sudo;
$ADMIN = $sudo;
$Dev = array("$sudo","6032111170");// ايديك
$Devd = "$sudo";
$tbbots = GCCGHbot;/// يوزر بوتك بدون @
 
$channel = "sanawe2_1";/// يوزر قناتك بدون@
$chinnl = "$channel";
$DevUser = "@$buy"; // 
$Devch = "@$buy"; //  
$Userbot = "$tbbots"; // 
